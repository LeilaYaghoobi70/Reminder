...
import ly.project.reminder.*
import ly.project.reminder.R
import ly.project.reminder.model.CalendarTypeItem
import ly.project.reminder.model.CityItem
import ly.project.reminder.services.ApplicationService
import ly.project.reminder.services.BroadcastReceivers
import ly.project.reminder.services.UpdateWorker
...
fun isArabicDigitSelected(): Boolean = false
...
fun formatNumber(number: String): String = number.toCharArray().map {
...
fun getDayIconResource(day: Int): Int =DAYS_ICONS_PERSIAN[day]
...
@StyleRes
fun getThemeFromName(name: String): Int =  R.style.DarkTheme
...
val Context.appPrefs: SharedPreferences
    get() = getSharedPreferences("appPrefs",MODE_PRIVATE )
