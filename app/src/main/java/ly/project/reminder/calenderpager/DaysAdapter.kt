...
import ly.project.reminder.model.DeviceCalendarEvent
...
class DaysAdapter internal constructor(
    ...
    inner class ViewHolder(itemView: DayView) : RecyclerView.ViewHolder(itemView),
        ...
        private val weekNumberTextSize = context.resources.getDimensionPixelSize(R.dimen.text_size)
        private val weekDaysInitialTextSize = context.resources.getDimensionPixelSize(R.dimen.text_size)
        private val persianDigitsTextSize = context.resources.getDimensionPixelSize(R.dimen.text_size)
